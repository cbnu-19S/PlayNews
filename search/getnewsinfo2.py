...
def getNewsData(post, DataResult):
    ...
    if date_mod is not None and writer is not None:
        DataResult.append({'cnt':cnt, 'title' : title, 'link' : link , 'date_first' : date_first.string, 'date_mod' : date_mod.string, 'newspaper':newspaper, 'writer':writer.string, 'context':context, 'img_link':img_link, 'img_alt':img_alt})

    elif date_mod is None and writer is not None:
         DataResult.append({'cnt':cnt, 'title' : title, 'link' : link , 'date_first' : date_first.string, 'date_mod' : None, 'newspaper':newspaper, 'writer':writer.string, 'context':context, 'img_link':img_link, 'img_alt':img_alt})
    elif date_mod is not None and writer is None:
         DataResult.append({'cnt':cnt, 'title' : title, 'link' : link , 'date_first' : date_first.string, 'date_mod' : date_mod.string, 'newspaper':newspaper, 'writer':None, 'context':context, 'img_link':img_link, 'img_alt':img_alt})
    else:
        DataResult.append({'cnt':cnt, 'title' : title, 'link' : link , 'date_first' : date_first.string, 'date_mod' : None, 'newspaper':newspaper, 'writer':None, 'context':context, 'img_link':img_link, 'img_alt':img_alt})
    return
